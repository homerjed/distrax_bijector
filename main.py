...
flags.DEFINE_integer("flow_num_layers", 4, "Number of layers to use in the flow.") # 8 
flags.DEFINE_integer("mlp_num_layers", 4, "Number of layers to use in the MLP conditioner.")
flags.DEFINE_integer("hidden_size", 16, "Hidden size of the MLP conditioner.") # 256
...
def make_flow_model(
    ...
    def bijector_fn(params: Array):
        return distrax.RationalQuadraticSpline(
				params, range_min=-5.0, range_max=10.0)
